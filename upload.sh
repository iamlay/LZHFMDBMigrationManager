...
DevelopVersionString=`grep -E 'version.develop.*=' LZHFMDBMigrationManager.podspec`
DevelopVersionNumber=`tr -cd 0-9 <<<"$DevelopVersionString"`
NewDevelopVersionNumber=$DevelopVersionNumber

TestVersionString=`grep -E 'version.test.*=' LZHFMDBMigrationManager.podspec`
TestVersionNumber=`tr -cd 0-9 <<<"$TestVersionString"`
NewTestVersionNumber=$TestVersionNumber

GrayVersionString=`grep -E 'version.gray.*=' LZHFMDBMigrationManager.podspec`
...
DevelopVersionLineNumber=`grep -nE 'version.develop.*=' LZHFMDBMigrationManager.podspec | cut -d : -f1`
sed -i "" "${DevelopVersionLineNumber}s/${DevelopVersionNumber}/${NewDevelopVersionNumber}/g" LZHFMDBMigrationManager.podspec
...
TestVersionLineNumber=`grep -nE 'version.test.*=' LZHFMDBMigrationManager.podspec | cut -d : -f1`
sed -i "" "${TestVersionLineNumber}s/${TestVersionNumber}/${NewTestVersionNumber}/g" LZHFMDBMigrationManager.podspec
echo "current test version is ${TestVersionNumber}, new version is ${NewTestVersionNumber}, line number is ${TestVersionLineNumber}"

GrayVersionLineNumber=`grep -nE 'version.gray.*=' LZHFMDBMigrationManager.podspec | cut -d : -f1`
sed -i "" "${GrayVersionLineNumber}s/${GrayVersionNumber}/${NewGrayVersionNumber}/g" LZHFMDBMigrationManager.podspec
echo "current gray version is ${GrayVersionNumber}, new version is ${NewGrayVersionNumber}, line number is ${GrayVersionLineNumber}"

VersionString=`grep -E 's.version.*=' LZHFMDBMigrationManager.podspec`
...
VersionLineNumber=`grep -nE 's.version.*=' LZHFMDBMigrationManager.podspec | cut -d : -f1`
sed -i "" "${VersionLineNumber}s/${VersionNumber}/${NewVersionNumber}/g" LZHFMDBMigrationManager.podspec
